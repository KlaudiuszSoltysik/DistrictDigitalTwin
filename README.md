...
1. **Global Energy Metering:** Measure and track total building energy consumption (Electricity and Gas in kWh).
2. **PV Energy Tracking:** Calculate total energy generated by the PV farm (kWh), not just current power (kW).
